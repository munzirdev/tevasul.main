...
serve(async (req) => {
  ...
  try {
    console.log('🔧 create-moderator-simple function called');
    ...
    console.log('✅ User is admin, proceeding with moderator creation');
    ...
    console.error('❌ Error in create-moderator-simple function:', error)
