...
const ChatBot: React.FC<ChatBotProps> = ({ isOpen, onToggle, isMinimized, onToggleMinimize }) => {
  ...
  const handleServiceButtonClick = async (buttonText: string) => {
      ...
      {!isMinimized && (
        <>
          ...
          <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 min-h-0" style={{ scrollBehavior: 'smooth' }}>
            ...
            {/* Service Buttons */}
            {messages.length === 0 && !isLoadingHistory && showServiceButtons && (
                <div className="px-3 md:px-4 pb-4">
                  <div className="grid grid-cols-2 gap-2 md:gap-3">
                    {language === 'ar' ? (
                      <>
                        <button
                          onClick={() => handleServiceButtonClick('أسعار التأمين الصحي')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-xl hover:from-blue-100 hover:to-indigo-100 dark:hover:from-blue-900/30 dark:hover:to-indigo-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">🩺</span>
                          <span className="text-xs font-semibold text-blue-700 dark:text-blue-300">التأمين الصحي</span>
                          <span className="text-xs text-blue-600 dark:text-blue-400 mt-1">أسعار حسب العمر</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('معلومات تجديد الإقامة')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 rounded-xl hover:from-green-100 hover:to-emerald-100 dark:hover:from-green-900/30 dark:hover:to-emerald-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">📄</span>
                          <span className="text-xs font-semibold text-green-700 dark:text-green-300">تجديد الإقامة</span>
                          <span className="text-xs text-green-600 dark:text-green-400 mt-1">إجراءات سريعة</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('خدمات الترجمة')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-700 rounded-xl hover:from-purple-100 hover:to-violet-100 dark:hover:from-purple-900/30 dark:hover:to-violet-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">📝</span>
                          <span className="text-xs font-semibold text-purple-700 dark:text-purple-300">الترجمة المحلفة</span>
                          <span className="text-xs text-purple-600 dark:text-purple-400 mt-1">ترجمة معتمدة</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('خدمات تحديث البيانات')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-700 rounded-xl hover:from-orange-100 hover:to-amber-100 dark:hover:from-orange-900/30 dark:hover:to-amber-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">🔄</span>
                          <span className="text-xs font-semibold text-orange-700 dark:text-orange-300">تحديث البيانات</span>
                          <span className="text-xs text-orange-600 dark:text-orange-400 mt-1">للحماية المؤقتة</span>
                        </button>
                      </>
                    ) : (
                      <>
                        <button
                          onClick={() => handleServiceButtonClick('Show health insurance prices')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-700 rounded-xl hover:from-blue-100 hover:to-indigo-100 dark:hover:from-blue-900/30 dark:hover:to-indigo-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">🩺</span>
                          <span className="text-xs font-semibold text-blue-700 dark:text-blue-300">Health Insurance</span>
                          <span className="text-xs text-blue-600 dark:text-blue-400 mt-1">Prices by age</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('Residence renewal information')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 rounded-xl hover:from-green-100 hover:to-emerald-100 dark:hover:from-green-900/30 dark:hover:to-emerald-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">📄</span>
                          <span className="text-xs font-semibold text-green-700 dark:text-green-300">Residence Renewal</span>
                          <span className="text-xs text-green-600 dark:text-green-400 mt-1">Fast procedures</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('Translation services')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-700 rounded-xl hover:from-purple-100 hover:to-violet-100 dark:hover:from-purple-900/30 dark:hover:to-violet-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">📝</span>
                          <span className="text-xs font-semibold text-purple-700 dark:text-purple-300">Certified Translation</span>
                          <span className="text-xs text-purple-600 dark:text-purple-400 mt-1">Official translation</span>
                        </button>
                        <button
                          onClick={() => handleServiceButtonClick('Data update services')}
                          className="flex flex-col items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-700 rounded-xl hover:from-orange-100 hover:to-amber-100 dark:hover:from-orange-900/30 dark:hover:to-amber-900/30 transition-all duration-200 text-left"
                        >
                          <span className="text-2xl mb-1">🔄</span>
                          <span className="text-xs font-semibold text-orange-700 dark:text-orange-300">Data Update</span>
                          <span className="text-xs text-orange-600 dark:text-orange-400 mt-1">For temporary protection</span>
                        </button>
                      </>
                    )}
                  </div>
